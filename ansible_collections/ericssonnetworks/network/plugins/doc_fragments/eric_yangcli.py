...
class ModuleDocFragment(object):
    # Standard ERIC_YANGCLI documentation fragment
    DOCUMENTATION = r'''
options:
    outputfile:
        description:
    ...
    deviceType:
        ...
        - NE2572
notes:
  - For more information on using Ansible to manage Ericsson Network devices see U(https://www.ansible.com/ansible-ericsson).
'''
