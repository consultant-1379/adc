...
#
# Contains CLIConf Plugin methods for ERIC_YANGCLI Modules
# Ericsson Networking
#
...
name: eric_yangcli
short_description: Use eric_yangcli cliconf to run command on Ericsson ERIC_YANGCLI platform
description:
  - This eric_yangcli plugin provides low level abstraction apis for
    sending and receiving CLI commands from Ericsson ERIC_YANGCLI network devices.
'''
...
class Cliconf(CliconfBase):
    ...
    def get_device_info(self):
        ...
        device_info['network_os'] = 'eric_yangcli'
